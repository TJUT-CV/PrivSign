...
def evaluate(prefix="./", mode="dev", evaluate_dir=None, evaluate_prefix=None,
    ...
    '''
    sclite_path = "/hdd1/phoenix2014-release/phoenix-2014-multisigner/evaluation/sctk-2.4.0/bin/sclite"
    print(os.getcwd())
    ...
    os.system(f"/home/xxx/anaconda3/envs/vac/bin/python3.7 {evaluate_dir}/mergectmstm.py {prefix}tmp2.ctm {prefix}tmp.stm")
