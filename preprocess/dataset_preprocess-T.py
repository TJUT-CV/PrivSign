...
def csv2dict(anno_path, dataset_type):
    ...
    inputs_list = (inputs_list.to_dict()['id|folder|start|end|signer|annotation|translation'].values())
    info_dict = dict()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='phoenix2014-T',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/home/tbt/data/phoenix-2014-T',
    ...
    for md in mode:
        ...
        generate_gt_stm(information, f"./{args.dataset}-groundtruth-{md}.stm")
        # resize images
