...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='phoenix2014',
                        help='save prefix')
    parser.add_argument('--dataset-root', type=str, default='/hdd2/lyx/ops-seem/std/phoenix2014-0',
                        help='path to the dataset')
    parser.add_argument('--annotation-prefix', type=str, default='manual/{}.corpus.csv',
