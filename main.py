...
class Processor():
    def __init__(self, arg):
        ...
        shutil.copy2('./modules/CorrNet_resnet.py', self.arg.work_dir)
        shutil.copy2('./seq_scripts.py', self.arg.work_dir)
        shutil.copy2('./slr_network.py', self.arg.work_dir)
    ...
    ###if not  semantic finetuning
    def load_model_weights(self, model, weight_path):
        state_dict = torch.load(weight_path)
        layer_name = list(state_dict['model_state_dict'].keys())
