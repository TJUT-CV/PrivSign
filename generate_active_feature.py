...
device_id = 1
dataset = 'phoenix2014'
prefix = '/hdd1/phoenix2014-release/phoenix-2014-multisigner/'
dict_path = f'./preprocess/{dataset}/gloss_dict.npy'
model_weights = '/hdd2/tbt/CorrNet/CorrNet-main/CorrNet_weights/CorrNet_dev_18.90_PHOENIX14.pt'
select_id = 2 #0  # The video selected to show
...
# save image
cam_show_img(vid, fmap, grads_val, out_dir='/hdd2/tbt-visual/Grad_CAM/CorrNet_baseline/2/')